...
number_credits = int(input("Введите количество должников: "))
res_credit = 0
for id in range(0, number_credits, 5):
    print(f"Должник с номером {id}")
    res_credit += int(input("Сколько должны? "))
print(f"Общая сумма долга: {res_credit}")